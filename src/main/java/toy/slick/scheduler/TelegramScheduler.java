...
public class TelegramScheduler {
    ...
    public void sendFearAndGreedSeoulTimeZone() throws IOException {
    ...
    public void sendFearAndGreedNewYorkTimeZone() throws IOException {
        String message = telegramMessageParser.parseFearAndGreed();
    ...
    public void sendEconomicEventList() throws IOException {
